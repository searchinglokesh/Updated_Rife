...
# 2. The second convolutional layer is a 3x3 convolutional layer with 32 output channels.
# 3. The third convolutional layer is a 3x3 convolutional layer with 64 output channels.
# 4. The fourth convolutional layer is a 3x3 convolutional layer with 128 output channels.
# 5. The fifth convolutional layer is a 3x3 convolutional layer with 256 output channels.
# 6. The sixth convolutional layer is a 3x3 convolutional layer with 512 output channels.
